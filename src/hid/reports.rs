...
pub(crate) fn ft260_set_request_u8(
    device: &Device,
    request: Request,
    value: u8,
) -> Ft260Result<()> {
...
pub(crate) fn ft260_set_request_u8x2(
    device: &Device,
    request: Request,
    value1: u8,
    value2: u8,
...
pub(crate) fn ft260_set_request_u16(
    device: &Device,
    request: Request,
    value: u16,
) -> Ft260Result<()> {
...
pub(crate) fn ft260_set_request_u32(
    device: &Device,
    request: Request,
    value: u32,
) -> Ft260Result<()> {
...
pub(crate) fn ft260_select_gpio2_function(
    device: &Device,
...
pub(crate) fn ft260_select_gpio_a_function(
    device: &Device,
...
pub(crate) fn ft260_select_gpio_g_function(
    device: &Device,
...
pub(crate) fn ft260_set_suspend_out_polarity(
    device: &Device,
...
pub(crate) fn ft260_enable_dcd_ri_pin(
    device: &Device,
...
pub(crate) fn ft260_i2c_master_read(
    device: &Device,
    device_address: u8,
    flag: I2cCondition,
    buf: &mut [u8],
...
pub(crate) fn ft260_i2c_master_write(
    device: &Device,
    device_address: u8,
    flag: I2cCondition,
    buf: &[u8],
...
pub(crate) fn ft260_uart_set_flow_control(
    device: &Device,
...
pub(crate) fn ft260_uart_set_data_bits(
    device: &Device,
...
pub(crate) fn ft260_uart_set_xon_xoff_char(
    device: &Device,
    x_on: u8,
    x_off: u8,
) -> Ft260Result<()> {
...
pub(crate) fn ft260_uart_enable_ri_wakeup(
    device: &Device,
    enable: WakeupIntEnableMode,
) -> Ft260Result<()> {
    let mut buf = feat_rep_buf();
...
pub(crate) fn ft260_uart_set_ri_wakeup_config(
    device: &Device,
...
pub(crate) fn ft260_gpio_set_dir(
    device: &Device,
    pin: GpioPinNum,
    dir: GpioDir,
) -> Ft260Result<()> {
