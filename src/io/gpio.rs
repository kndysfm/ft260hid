...
impl<'a> Gpio<'a> {
  ...
  pub fn enable_pin(&self, group: Group) -> Ft260Result<()> {
    match group {
      ...
      Group::Gpio_3 => reports::ft260_set_wakeup_interrupt(self.device, WakeupIntEnableMode::Disabled),
      Group::Gpio_4_5 => reports::ft260_enable_dcd_ri_pin(self.device, UartDcdRiEnableMode::Disabled),
      Group::Gpio_A => reports::ft260_select_gpio_a_function(self.device, GpioAFunction::Gpio),
      Group::Gpio_B_C_D_E_F_H => reports::ft260_enable_uart_pin(self.device, UartEnableMode::Off),
      Group::Gpio_G => reports::ft260_select_gpio_g_function(self.device,GpioGFunction::Gpio),
    }
  }
  ...
  pub fn disable_pin(&self, group: Group) -> Ft260Result<()> {
    match group {
      ...
      Group::Gpio_2 => reports::ft260_select_gpio2_function(self.device, Gpio2Function::SuspOut),
      Group::Gpio_3 => reports::ft260_set_wakeup_interrupt(self.device, WakeupIntEnableMode::Enabled),
      Group::Gpio_4_5 => reports::ft260_enable_dcd_ri_pin(self.device, UartDcdRiEnableMode::Enabled),
      Group::Gpio_A => reports::ft260_select_gpio_a_function(self.device, GpioAFunction::TxActive),
      Group::Gpio_B_C_D_E_F_H => reports::ft260_enable_uart_pin(self.device, UartEnableMode::NoFlowControl),
      Group::Gpio_G => reports::ft260_select_gpio_g_function(self.device,GpioGFunction::BcdDet),
    }
  }
